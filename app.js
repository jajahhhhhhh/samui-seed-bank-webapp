...
const translations = {
  ...
  fr: {
    ...
    infoTitle: 'Votre porte vers l'excellence médicale!',
    infoP1: 'Découvrez Samui Seed Bank : Niché au cœur de Chaweng sur l'île de Koh Samui, la première et unique vraie banque de gènes médicaux de Koh Samui.',
    infoBtn: 'Ouvrez un monde de médecine alternative!',
    contactTitle: 'Contactez-nous', contactSub: 'Votre porte vers l'excellence médicale!',
